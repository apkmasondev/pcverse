        ...
        <AnimatePresence>
          {buildMode && currentComponent?.role && currentStep <= maxSteps && (
            <motion.div
              ...
              className="group w-[40px] hover:w-[260px] xl:w-[48px] xl:hover:w-[340px] max-h-[40px] xl:max-h-[48px] hover:max-h-[600px] overflow-hidden flex flex-col items-start bg-black/20 hover:bg-black/60 backdrop-blur-md border-l-2 border-rose-500/70 rounded-r-xl shadow-[20px_0_30px_rgba(0,0,0,0.2)] pointer-events-auto transition-all duration-500 ease-out"
            >
              <div className="w-[260px] xl:w-[340px] shrink-0 flex flex-col">
                <div className="flex items-center h-[40px] xl:h-[48px] gap-2 px-3 bg-rose-500/10 cursor-help">
                  ...
                  <span className="text-rose-300/90 font-bold uppercase tracking-widest text-[10px] xl:text-[11px] [text-shadow:0_1px_2px_rgba(0,0,0,1)] opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100 whitespace-nowrap">
                    Rola w Systemie
                  </span>
                </div>
                <div className="px-3 pb-4 pt-2 flex flex-col gap-2 text-xs xl:text-sm leading-relaxed [text-shadow:0_1px_3px_rgba(0,0,0,1)] text-left opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-150">
        ...
        <AnimatePresence>
          {buildMode && currentComponent?.buildTip && currentStep <= maxSteps && (
            <motion.div
              ...
              className="group w-[40px] hover:w-[240px] xl:w-[48px] xl:hover:w-[320px] max-h-[40px] xl:max-h-[48px] hover:max-h-[600px] overflow-hidden flex flex-col items-start bg-black/20 hover:bg-black/60 backdrop-blur-md border-l-2 border-indigo-500/70 rounded-r-xl shadow-[20px_0_30px_rgba(0,0,0,0.2)] pointer-events-auto transition-all duration-500 ease-out mt-1"
            >
              <div className="w-[240px] xl:w-[320px] shrink-0 flex flex-col">
                <div className="flex items-center h-[40px] xl:h-[48px] gap-2 px-3 bg-indigo-500/10 cursor-help">
                  ...
                  <span className="text-indigo-300/90 font-bold uppercase tracking-widest text-[10px] xl:text-[11px] [text-shadow:0_1px_2px_rgba(0,0,0,1)] opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100 whitespace-nowrap">
                    Porada Eksperta
                  </span>
                </div>
                <div className="px-3 pb-4 pt-2 text-slate-200/90 text-xs xl:text-sm leading-relaxed [text-shadow:0_1px_3px_rgba(0,0,0,1)] text-left opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-150">
        ...
        <AnimatePresence>
          {buildMode && currentComponent?.expertDetails && currentStep <= maxSteps && (
            <motion.div
              ...
              className="group w-[40px] hover:w-[240px] xl:w-[48px] xl:hover:w-[320px] max-h-[40px] xl:max-h-[48px] hover:max-h-[600px] overflow-hidden flex flex-col items-start bg-black/20 hover:bg-black/60 backdrop-blur-md border-l-2 border-amber-500/70 rounded-r-xl shadow-[20px_0_30px_rgba(0,0,0,0.2)] pointer-events-auto transition-all duration-500 ease-out mt-1"
            >
              <div className="w-[240px] xl:w-[320px] shrink-0 flex flex-col">
                <div className="flex items-center h-[40px] xl:h-[48px] gap-2 px-3 bg-amber-500/10 cursor-help">
                  ...
                  <span className="text-amber-400/90 font-bold uppercase tracking-widest text-[10px] xl:text-[11px] [text-shadow:0_1px_2px_rgba(0,0,0,1)] opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100 whitespace-nowrap">
                    Narzędzia i Parametry
                  </span>
                </div>
                <div className="px-3 pb-4 pt-2 flex flex-col gap-2 text-xs xl:text-sm [text-shadow:0_1px_3px_rgba(0,0,0,1)] opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-150">
        ...
        <AnimatePresence>
          {buildMode && currentComponent?.perfImpact && currentStep <= maxSteps && (
            <motion.div
              ...
              exit={{ opacity: 0, x: 50, scale: 0.9 }}
              transition={{ type: "spring", damping: 20, stiffness: 300, delay: 0.1 }}
              className="group w-[40px] hover:w-[220px] xl:w-[48px] xl:hover:w-[260px] max-h-[40px] xl:max-h-[48px] hover:max-h-[600px] overflow-hidden flex flex-col items-end bg-black/20 hover:bg-black/60 backdrop-blur-md border-r-2 border-fuchsia-500/70 rounded-l-xl shadow-[-20px_0_30px_rgba(0,0,0,0.2)] pointer-events-auto transition-all duration-500 ease-out"
            >
              <div className="w-[220px] xl:w-[260px] shrink-0 flex flex-col">
                <div className="flex items-center justify-end h-[40px] xl:h-[48px] gap-2 px-3 bg-fuchsia-500/10 cursor-help">
                  <span className="text-fuchsia-400/90 font-bold uppercase tracking-widest text-[10px] xl:text-[11px] [text-shadow:0_1px_2px_rgba(0,0,0,1)] opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100 whitespace-nowrap">
                    Wpływ na Wydajność
                  </span>
                  <Zap size={16} className="text-fuchsia-400 drop-shadow-[0_0_5px_rgba(217,70,239,0.8)] shrink-0 xl:w-5 xl:h-5" />
                </div>
                <div className="px-3 pb-4 pt-2 flex flex-col gap-2.5 text-[11px] xl:text-xs font-mono [text-shadow:0_1px_3px_rgba(0,0,0,1)] opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-150 text-right">
        ...
        <AnimatePresence>
          {buildMode && currentComponent?.customStats && currentStep <= maxSteps && (
            <motion.div
              ...
              exit={{ opacity: 0, x: 50, scale: 0.9 }}
              transition={{ type: "spring", damping: 20, stiffness: 300, delay: 0.2 }}
              className="group w-[40px] hover:w-[200px] xl:w-[48px] xl:hover:w-[240px] max-h-[40px] xl:max-h-[48px] hover:max-h-[600px] overflow-hidden flex flex-col items-end bg-black/20 hover:bg-black/60 backdrop-blur-md border-r-2 border-cyan-500/70 rounded-l-xl shadow-[-20px_0_30px_rgba(0,0,0,0.2)] pointer-events-auto transition-all duration-500 ease-out mt-1"
            >
              <div className="w-[200px] xl:w-[240px] shrink-0 flex flex-col">
                <div className="flex items-center justify-end h-[40px] xl:h-[48px] gap-2 px-3 bg-cyan-500/10 cursor-help">
                  <span className="text-cyan-400/90 font-bold uppercase tracking-widest text-[10px] xl:text-[11px] [text-shadow:0_1px_2px_rgba(0,0,0,1)] opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100 whitespace-nowrap">
                    Telemetria
                  </span>
        ...
        <AnimatePresence>
          {buildMode && currentComponent?.exampleSpecs && currentStep <= maxSteps && (
            <motion.div
              ...
              className="group w-[40px] hover:w-[200px] xl:w-[48px] xl:hover:w-[240px] max-h-[40px] xl:max-h-[48px] hover:max-h-[600px] overflow-hidden flex flex-col items-end bg-black/20 hover:bg-black/60 backdrop-blur-md border-r-2 border-emerald-500/70 rounded-l-xl shadow-[-20px_0_30px_rgba(0,0,0,0.2)] pointer-events-auto transition-all duration-500 ease-out mt-1"
            >
              <div className="w-[200px] xl:w-[240px] shrink-0 flex flex-col">
                <div className="flex items-center justify-end h-[40px] xl:h-[48px] gap-2 px-3 bg-emerald-500/10 cursor-help">
                  <span className="text-emerald-400/90 font-bold uppercase tracking-widest text-[10px] xl:text-[11px] [text-shadow:0_1px_2px_rgba(0,0,0,1)] opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100 whitespace-nowrap">
                    Przykładowe Modele
                  </span>
                  <Cpu size={16} className="text-emerald-400 drop-shadow-[0_0_5px_rgba(16,185,129,0.8)] shrink-0 xl:w-5 xl:h-5" />
                </div>
                <div className="px-3 pb-4 pt-2 flex flex-col gap-3 [text-shadow:0_1px_3px_rgba(0,0,0,1)] opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-150 text-right">
