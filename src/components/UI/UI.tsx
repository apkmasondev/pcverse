        ...
        <AnimatePresence>
          {buildMode && currentComponent?.buildTip && currentStep <= maxSteps && (
            <motion.div
              ...
              className="w-[calc(100vw-3rem)] max-w-sm flex flex-col bg-[#0a0a0a]/80 backdrop-blur-3xl border border-indigo-500/30 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden pointer-events-auto"
            >
        ...
        <AnimatePresence>
          {buildMode && currentComponent?.expertDetails && currentStep <= maxSteps && (
            <motion.div
              ...
              className="w-[calc(100vw-3rem)] max-w-sm flex flex-col bg-[#0a0a0a]/80 backdrop-blur-3xl border border-amber-500/30 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden pointer-events-auto"
            >
              ...
              <div className="p-4 flex flex-col gap-3 text-sm">
                <div className="flex items-start gap-3">
                  <div className="text-amber-500/70 font-semibold w-24 shrink-0">Wymagane:</div>
                  <div className="text-slate-300">{currentComponent.expertDetails.tool}</div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="text-amber-500/70 font-semibold w-24 shrink-0">Parametr:</div>
        ...
        <AnimatePresence>
          {buildMode && currentComponent?.customStats && currentStep <= maxSteps && (
            <motion.div
              ...
              className="w-[calc(100vw-3rem)] max-w-xs flex flex-col bg-[#0a0a0a]/80 backdrop-blur-3xl border border-cyan-500/30 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden pointer-events-auto"
            >
              <div className="flex items-center gap-3 bg-cyan-500/10 px-4 py-3 border-b border-cyan-500/20">
              ...
              <div className="p-4 flex flex-col gap-4 text-sm font-mono">
                {currentComponent.customStats.map((stat, idx) => (
                  <div key={idx} className="flex flex-col gap-1">
                    <div className="flex justify-between text-cyan-100/70 text-[10px] uppercase tracking-wider">
        ...
        <AnimatePresence>
          {buildMode && currentComponent?.exampleSpecs && currentStep <= maxSteps && (
            <motion.div
              ...
              className="w-[calc(100vw-3rem)] max-w-xs flex flex-col bg-[#0a0a0a]/80 backdrop-blur-3xl border border-emerald-500/30 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden pointer-events-auto"
            >
              <div className="flex items-center gap-3 bg-emerald-500/10 px-4 py-3 border-b border-emerald-500/20">
                <div className="w-8 h-8 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-400">
                  <Cpu size={16} />
                </div>
                <span className="text-emerald-400 font-bold uppercase tracking-wider text-xs font-mono">
              ...
              <div className="p-4 flex flex-col gap-4">
                {currentComponent.exampleSpecs.map((spec, idx) => (
                  <div key={idx} className="flex flex-col gap-1">
                    <div className="text-[10px] text-emerald-500/80 uppercase tracking-widest font-bold">{spec.brand}</div>
                    <div className="text-emerald-100 font-bold text-sm leading-tight">{spec.model}</div>
                    <div className="text-emerald-300/70 text-[11px] leading-snug">{spec.specs}</div>
                  </div>
                ))}
              </div>
            </motion.div>
